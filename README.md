...
- **Mekanisme Failover Handal**: Jika model AI utama mengalami batas kuota (rate limit) atau kegagalan koneksi RSS berita eksternal terganggu, sistem memiliki pertahanan berlapis dengan beralih secara otomatis ke model cadangan (`gemini-2.5-flash`, `gemini-2.0-flash`, `gemini-1.5-flash`) dan data berita cadangan lokal agar juri tetap mendapatkan pengalaman uji coba yang mulus tanpa interupsi kesalahan (*error-free testing*).
